function [y,mappedData] = wlanHTData_SURI(PSDU,cfgHT,varargin)
% addpath '/usr/local/MATLAB/R2015b/toolbox/wlan/wlan'
% addpath '/usr/local/MATLAB/R2015b/toolbox/wlan/wlan/'
...
validateattributes(PSDU, {'double', 'int8'}, ...
    ...
    'wlan:wlanHTData:InvalidInputPSDU', 'PSDU input');
...
% Get OFDM parameters
cfgOFDM = wlanGetOFDMConfig(cfgHT.ChannelBandwidth, cfgHT.GuardInterval, 'HT', numSTS);
